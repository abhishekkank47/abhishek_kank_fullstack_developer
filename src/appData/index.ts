...
export const serviceData = [
  {
    ...
    shortDescription: 'Building scalable REST and real-time APIs with Node.js, Express.js, and TypeScript.',
  },
  {
    icon: PostgresIcon,
    title: 'Relational Database Design',
    shortDescription: 'Designing and optimizing schemas with PostgreSQL & Prisma for reliable data consistency.',
  },
  {
    icon: MongodbIcon,
    title: 'NoSQL & Document Stores',
    shortDescription: 'Implementing flexible data models and high-performance queries with MongoDB.',
  },
  {
    icon: RedisIcon,
    title: 'Caching & Performance',
    shortDescription: 'Boosting system performance using Redis for caching, sessions, and rate-limiting.',
  },
  {
    icon: RabbitmqIcon,
    title: 'Message Queues & Async Systems',
    shortDescription: 'Decoupling services and enabling real-time processing with RabbitMQ.',
  },
  {
    icon: DockerIcon,
    title: 'Containerization & DevOps',
    shortDescription: 'Packaging apps with Docker and deploying production workloads efficiently.',
  },
  {
    icon: KubernetesIcon,
    title: 'Kubernetes Orchestration',
    shortDescription: 'Managing microservices, scaling, and deployments with Kubernetes.',
  },
  {
    icon: AwsIcon,
    title: 'Cloud Integration (AWS)',
    shortDescription: 'Leveraging AWS services like EC2 & S3 for hosting, storage, and scalability.',
  },
  {
    icon: ReactIcon,
...
export const skillList = [
  ...
  // Realtime / Extra
  // { name: 'GitHub & CI/CD', icon: GithubIcon },
];
